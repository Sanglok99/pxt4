...
EXPORT_SYMBOL(pxt4_read_bh); // open_syscall_module
...
EXPORT_SYMBOL(pxt4_inode_bitmap); // open_syscall_module
...
EXPORT_SYMBOL(pxt4_free_group_clusters);
...
EXPORT_SYMBOL(pxt4_free_inodes_count); // open_syscall_module
...
EXPORT_SYMBOL(pxt4_used_dirs_count); // open_syscall_module
...
EXPORT_SYMBOL(pxt4_itable_unused_count); // open_syscall_module
...
EXPORT_SYMBOL(pxt4_free_group_clusters_set); // open_syscall_module
...
EXPORT_SYMBOL(pxt4_free_inodes_set); // open_syscall_module
...
EXPORT_SYMBOL(pxt4_used_dirs_set); // open_syscall_module
...
EXPORT_SYMBOL(pxt4_itable_unused_set); // open_syscall_module
...
EXPORT_SYMBOL(__pxt4_error); // open_syscall_module
...
EXPORT_SYMBOL(__pxt4_std_error); // open_syscall_module
...
EXPORT_SYMBOL(__pxt4_warning); // open_syscall_module
...
EXPORT_SYMBOL(pxt4_mark_group_bitmap_corrupted); // open_syscall_module
...
EXPORT_SYMBOL(pxt4_group_desc_csum_set); // open_syscall_module
