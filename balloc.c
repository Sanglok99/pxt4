...
EXPORT_SYMBOL(pxt4_free_clusters_after_init); // open_syscall_module
...
EXPORT_SYMBOL(pxt4_get_group_info); // open_syscall_module
...
EXPORT_SYMBOL(pxt4_read_block_bitmap); // open_syscall_module
...
EXPORT_SYMBOL(pxt4_should_retry_alloc); // open_syscall_module
